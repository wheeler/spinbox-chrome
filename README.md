...
The feed page shows all your "followed" artists tracks in chronological order. It has the downside that you cannot "pick
up where you left off" if you return to the feed later. This extension allows you to quickly pull tracks into a playlist
to review later and persistently hide tracks from your feed so you won't have to sift through them all over again.

## Description

Adds two buttons to the SoundCloud feed page:
"Pull" - quickly place the track into a playlist to review later and hide the track from your feed.
"Hide (✕)" - hide the track from your feed.

When the currently playing track is hidden, automatically start playing the next track. Details of recently hidden
tracks are displayed in the sidebar. Tracks can be un-hidden there.

Example workflow: Go through your feed, for tracks that you like and want to consider using/buying, hit the "pull"
button to quickly place them in a playlist to review later. Hide tracks that you aren't interested in. This way all
tracks that you've already been "digging" through will not appear on your next visit to the feed, and you can pick up
where you left off (after any newer tracks have been added to the top).
...
- Correctly skip hidden tracks when playing the next track.
...
- Option to Mute already liked tracks
- Playlist management features: move tracks between playlists quickly. (e.g. "Pull" → "Bought")
- Option to mute tracks already in playlists (hard? how would we know without querying?)
- Optional Turbo mode(?)
